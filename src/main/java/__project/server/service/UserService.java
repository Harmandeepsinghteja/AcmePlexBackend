...
public class UserService {
    ...
    public String addUser(User newUser) {
        ...
        // Since we used the @GeneratedValue annotation for the id attribute of User,
        // the id in the newUser object will
    ...
    // With transaction, you can just fetch a user from the database, and update its
